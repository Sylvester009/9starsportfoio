          ...
          <div className="flex flex-col gap-8 @[864px]:w-1/2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <h1 className="text-4xl md:text-6xl font-black leading-[1.1] tracking-tight text-slate-900">
                I build{" "}
                <span className="text-[#f47b25]">scalable</span>,{" "}
                <span className="text-[#f47b25]">high-performance</span>{" "}
                web applications with React & Next.js
              </h1>

              {/* Subtext */}
              <p className="text-lg md:text-xl text-slate-600 max-w-xl leading-relaxed">
                Frontend engineer focused on crafting responsive, production-ready interfaces with clean architecture, reusable components, and seamless user experiences.
              </p>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="#projects"
                className="flex min-w-[160px] items-center justify-center rounded-lg h-14 px-6 bg-[#f47b25] text-white text-base font-bold shadow-xl shadow-[#f47b25]/30 hover:bg-[#f47b25]/90 transition-all"
              >
                View Projects
              </Link>
              ...
              <Link
                href="#experience"
                className="flex min-w-[160px] items-center justify-center rounded-lg h-14 px-6 border-2 border-slate-200 text-base font-bold hover:bg-slate-100 transition-all"
              >
                Experience
              </Link>
            </div>
